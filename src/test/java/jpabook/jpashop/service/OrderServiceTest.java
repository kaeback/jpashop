...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception {
        ...
        // then
        Order getOrder = orderRepository.findOne(orderId);
        assertEquals(OrderStatus.CANCLE, getOrder.getStatus(), "주문 취소 시 상태는 CANCEL 이다.");
    ...
    private Book createBook(String name, int price, int stockQeuantity) {
        Book book = new Book();
        book.setName(name);
        book.setPrice(price);
        book.setStockQuantity(stockQeuantity);
